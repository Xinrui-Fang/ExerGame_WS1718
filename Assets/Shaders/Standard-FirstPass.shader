...
Shader "ExerGame/Nature/Terrain/Standard-UVMix" {
    Properties {
    ...
    SubShader {
        ...
        #include "TerrainSplatmapCommon_UVMix.cginc"
    ...
    Dependency "AddPassShader" = "Hidden/ExerGame/TerrainEngine/Splatmap/Standard-AddPass-UVMix"
    Dependency "BaseMapShader" = "Hidden/TerrainEngine_UVMix/Splatmap/Standard-Base"

    Fallback "ExerGame/Nature/Terrain/Diffuse-UVMix"
}
